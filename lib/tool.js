import { D as DEFAULT_SHADOW_ID } from "./chunks/runtime-BS1I_El4.js";
...
function apply(ctx) {
	...
	ctx.tools.register(defineTool({
		...
		parameters: {
			...
			maxPromptChars: {
				type: "number",
				description: "Complete prompt bound; 0 disables the limit."
			},
			maxReportChars: {
				type: "number",
				description: "Accepted report bound; 0 disables the limit."
			},
			valueLoopEnabled: {
				type: "boolean",
