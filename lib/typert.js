import { z } from "zod";
//#region src/generated/typert.host.js
...
const _shadowMindStage$schema = z.enum([
	"prepare",
	"start",
	"run",
	"dispose",
		...
		},
		{
			...
			parameters: [{
				...
				codec: {
					mode: "strict",
					typeSymbol: "@deepseek-ai/dsh-session/types#SessionId",
					create: () => _deepseek_ai_dsh_shadow_mind_runtime_shadowMind_cycles_parameter_0$schema
				}
			}],
			result: {
				mode: "strict",
		...
		},
		{
			...
			parameters: [{
				...
				codec: {
					...
					create: () => _deepseek_ai_dsh_shadow_mind_runtime_shadowMind_saveDefault_parameter_0$schema
				}
			}],
			result: {
				mode: "strict",
		...
		},
		{
			...
			parameters: [{
				...
				codec: {
					mode: "strict",
					typeSymbol: "@deepseek-ai/dsh-session/types#SessionId",
					create: () => _deepseek_ai_dsh_shadow_mind_runtime_shadowMind_pause_parameter_0$schema
				}
			}],
			result: {
				mode: "strict",
		...
		},
		{
			...
			parameters: [{
				...
				codec: {
					mode: "strict",
					typeSymbol: "@deepseek-ai/dsh-session/types#SessionId",
					create: () => _deepseek_ai_dsh_shadow_mind_runtime_shadowMind_resume_parameter_0$schema
				}
			}],
			result: {
				mode: "strict",
		...
		},
		{
			...
			parameters: [{
				...
				codec: {
					mode: "strict",
					typeSymbol: "@deepseek-ai/dsh-session/types#SessionId",
					create: () => _deepseek_ai_dsh_shadow_mind_runtime_shadowMind_status_parameter_0$schema
				}
			}],
			result: {
				mode: "strict",
		...
		},
		{
			...
			parameters: [{
				...
				codec: {
					mode: "strict",
					typeSymbol: "@deepseek-ai/dsh-session/types#SessionId",
					create: () => _deepseek_ai_dsh_shadow_mind_runtime_shadowMind_toggle_parameter_0$schema
				}
			}],
			result: {
				mode: "strict",
